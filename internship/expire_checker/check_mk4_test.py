...
def calculate_remaining_time(future_date_str):
    ...
    # -------------------------- CONTROL AREA ---------------------------------
    end_time = time.perf_counter()
    print(f"Calculated remaining time for {future_date_str} in {end_time - start_time:.4f} seconds")
    # --------------------------------------------------------------------------
...
def main():
    ...
    # ----------------------------- CONTROL AREA -------------------------------
    end_time_print = time.perf_counter()
    print(f"Printing the sorted data took {end_time_print - start_time_print:.4f} seconds")
    # --------------------------------------------------------------------------
